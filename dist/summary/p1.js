...
exports.buildSection1 = buildSection1;
exports.assembleFinalReport = assembleFinalReport;
exports.renderReportPdf = renderReportPdf;
exports.buildMinimalFallbackReport = buildMinimalFallbackReport;
const pdf_1 = require("../infra/pdf");
function buildSection1(windowBundle) {
    return [
...
function assembleFinalReport(windowBundle, finalSections) {
    const parts = [];
...
function renderReportPdf(reportText) {
    ...
    return (0, pdf_1.buildSummaryPdf)(lines);
}
function buildMinimalFallbackReport(windowBundle) {
    const section2 = [
