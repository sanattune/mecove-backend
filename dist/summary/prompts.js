...
exports.buildCanonicalizerPrompt = buildCanonicalizerPrompt;
exports.buildWriterS2S3Prompt = buildWriterS2S3Prompt;
exports.buildWriterS4Prompt = buildWriterS4Prompt;
exports.buildGuardfixPrompt = buildGuardfixPrompt;
...
function buildCanonicalizerPrompt(windowBundle) {
...
function buildWriterS2S3Prompt(canonical, section3AllowedByCounts) {
...
function buildWriterS4Prompt(canonical) {
...
function buildGuardfixPrompt(canonical, draftS2S3, draftS4, section3AllowedByCounts) {
