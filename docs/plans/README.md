...
_Last reconciled: 2026-06-23_ (coach-support Phases 0–4 shipped)
...
|---|---|---|---|---|---|
| [plan_coach-support](plan_coach-support.md) | PARTIAL | NOW | 2026-06-23 | — | Phases 0–4 DONE (data model, pro onboarding, engagement create, client accept+reconcile, **insight sharing**: share/unshare/auto-send + pro derived read). Phases 5–8 pending (lifecycle/expiry → notifications → account-delete → verification). |
