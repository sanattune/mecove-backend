...
_Last reconciled: 2026-06-23_ (coach-support Phases 0–1 shipped)
...
|---|---|---|---|---|---|
| [plan_coach-support](plan_coach-support.md) | PARTIAL | NOW | 2026-06-23 | — | Phases 0 (data model) + 1 (pro onboarding: `/professional/profiles`) DONE. Phases 2–8 pending (engagement → accept → sharing → lifecycle → notifications → account-delete → verification). |
