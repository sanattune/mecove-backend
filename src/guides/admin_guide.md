*Admin commands*
/approve <phone> — approve a waitlisted user (e.g. /approve +919876543210)
/revoke <phone> — remove access from a user
/waitlist — list users waiting for access
/users — list all approved users (admins tagged)
/userstats — show last message activity date for all users
